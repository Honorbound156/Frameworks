...
public class ContextDiagram extends Application implements EventHandler<ActionEvent> {

	ContextFrame problemFrame;
	Boolean debug = true;
	...
	public void start(Stage primaryStage) {
		...
		domainSandboxLayout.setOnMouseClicked( e -> {
			...
			if(xOfClick > 0){
				...
				if(nameOfDomain.isPresent()){
					
					DomainPane domainPane = new DomainPane(xOfClick, yOfClick, domainCreated);
					domainSandboxLayout.getChildren().add(domainPane);
	...
	public void eraseProblemFrame(){
		this.problemFrame = new ContextFrame();
	}
