...
public class DomainPane extends Pane{
	Domain associatedDomain;
	
	public DomainPane(double xCoordinate, double yCoordinate, Domain domain){
		this.associatedDomain = domain;
		this.setBackground(new Background(new BackgroundFill(Color.web("Yellow"), CornerRadii.EMPTY, Insets.EMPTY)));
		...
		this.setOnMouseClicked(e -> {System.out.println(this.associatedDomain.getName() + " has been clicked on");});
		this.setOnMouseDragged(e -> {
			System.out.println(this.associatedDomain.getName() + "is being dragged to: " + e.getSceneX() + "," + e.getSceneY());
			//left
